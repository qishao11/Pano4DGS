...
class DroidNet(nn.Module):
    ...
    def forward(self, Gs, images, disps, intrinsics, graph=None, num_steps=12, fixedp=2, depth_only=False):
        ...
        for step in range(num_steps):
            ...
            for i in range(2):
                if depth_only:
                    _, disps = BA(target, weight, eta, Gs, disps, intrinsics, ii, jj, fixedp=2)
                else:
